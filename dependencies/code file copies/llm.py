...
def count_tokens(input_string):  # no unittests
    ...
    return token_count
TOKEN_PRICE_DICT = {  # last updated 10-01-25 BA
    'gpt-5':{'input_token_price':1.25, 'output_token_price':10, 'cached_input_token_price': 0.125},  # costs in $/million tokens
    'gpt-5-mini':{'input_token_price':.25, 'output_token_price':2, 'cached_input_token_price': 0.025},
    'gpt-5-nano':{'input_token_price':.05, 'output_token_price':.40, 'cached_input_token_price': 0.005},
    'gpt-4.1':{'input_token_price':2, 'output_token_price':8, 'cached_input_token_price': 0.50},
    'gpt-4.1-mini':{'input_token_price':.40, 'output_token_price':1.60, 'cached_input_token_price': 0.10},
    ...
    'gpt-4o-2024-05-13':{'input_token_price':5, 'output_token_price':15, 'cached_input_token_price': 0},
