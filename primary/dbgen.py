...
def save_user_hash_log_from_s3(users_hash_log_file_key, output_dir='exchanges'):
    ...
    """
    from primary.aws import get_s3_object
    bucket = "fofsecure"
...
def download_exchanges_from_s3(bucket="fofsecure", s3_path="exchanges", local_dir="exchanges", verbose=False):
    """
    ...
    """
    from primary.aws import list_s3_files, get_s3_object
