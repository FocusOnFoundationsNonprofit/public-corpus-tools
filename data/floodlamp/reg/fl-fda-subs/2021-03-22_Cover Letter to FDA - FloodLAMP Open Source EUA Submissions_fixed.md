...
primary file: 2021-03-22_Cover Letter to FDA - FloodLAMP Open Source EUA Submissions.docx
conversion: pandoc
notes:
...
These new submissions are for direct tests rather than the glass milk purification from our pre-EUA. Both tests utilize the same shelf stable chemical plus heat inactivation protocol. The FloodLAMP QuickColorTM COVID-19 Test uses a colorimetric LAMP amplification that is visually read by a simple color change. The FloodLAMP EasyPCRTM COVID-19 Test uses a one-step PCR amplification in duplex with an internal control.
