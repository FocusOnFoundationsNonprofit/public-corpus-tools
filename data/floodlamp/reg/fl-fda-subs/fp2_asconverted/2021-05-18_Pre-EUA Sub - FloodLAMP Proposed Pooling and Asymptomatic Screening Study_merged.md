...
-   The final concentration of inactivated virus in the 1X Inactivation Saline Solution is approximately 3x the LoD of the assay.
    ...
    -   **[FloodLAMP EasyPCR^TM^ COVID-19 Test]{.mark}**: 10,000 copies/mL (\~3 x 3,100)

    -   **[FloodLAMP QuickColor^TM^ COVID-19 Test]{.mark}**: 40,000 copies/mL (\~3 x 12,500)
...
-   Results criteria:
    ...
    -   The Ct score difference for **[FloodLAMP EasyPCR^TM^ COVID-19 Test]{.mark}** between the pooled and single swab protocols does not exceed 1.7 Ct;
