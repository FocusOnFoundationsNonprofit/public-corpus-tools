**Template for Manufacturers of Molecular and Antigen Diagnostic COVID-19 Tests for Non-Laboratory Use** [1]
...
1.  ***<u>Description of Test Steps:</u>***
...
1.  **<u>Quick Reference Instructions:</u>**
...
1.  **<u>Mobile Applications and Software</u>**
...
1.  ***<u>Components Included with the Test</u>***
...
1.  **<u>EMC (electrical and mechanical safety) Testing:</u>**
...
**J. <span class="smallcaps">PERFORMANCE EVALUATION</span>**
...
1.  **<u>Inclusivity (analytical sensitivity)</u>**

> **Please provide information consistent with the recommendations in the <u>Antigen Template for Manufacturers</u> or <u>Molecular Diagnostic Template for Manufacturers.</u>**

1.  **<u>Cross-reactivity (Analytical Specificity)</u>**
...
1.  Cross-reactivity (organisms tested in the absence of SARS-CoV-2)

2.  Microbial Interference Studies (organisms tested in the presence of SARS-CoV-2)

3.  Endogenous Interference Substances Studies (including common household items such as cleaners, lotions, soap etc.)

<!-- -->

1.  **<u>High-dose Hook Effect Study for antigen tests</u>**

> **Please provide information consistent with the recommendations in the <u>Antigen Template for Manufacturers.</u>**

1.  **<u>Biotin interference</u>, if applicable**
...
1.  **40°C and 95% RH (mimicking hot and humid climates)**

2.  **Delay in sample testing**

3.  **Delay in operational steps**

4.  **Delay in reading results**

5.  **Sample volume variability (if applicable)**

6.  **Buffer volume variability (if applicable)**

7.  **Mixing/swab expression variability (if applicable)**

8.  **Disturbance during analysis**

9.  **Placement on non-level surface**

10. **Impact of different light sources (if applicable)**

11. **If hand-held, positioning at 90° angle (simulating placing device in pocket or lifting to see result display screen)**
...
1.  **<span class="mark"><u>Clinical Evaluation:</u></span>**
...
1.  **<u>Adding Asymptomatic Testing Post-Authorization</u>**
...
1.  **<u>Symptomatic Patient Testing (prescription use only)</u>**
...
1.  **<u>Temperature and Humidity:</u>**
...
1.  **<u>Disturbance during analysis:</u>**
