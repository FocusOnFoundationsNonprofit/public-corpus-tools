#  \_Testing Checklist - Portola v1.1

Last updated: 9-8-2022 by Gary Withey
...
-   Travel to each class and set up at drop off point **Time:**
...
-   Continue intaking as participants drop off tubes until cut-off time <span class="mark">9:05am</span>

-   ***Communicate*** any intake anomalies (QR code and anomaly description)

## 

## Upon Return to Portola Time:
...
-   ***Communicate*** Result image & lookup map Time:
...
-   ***Communicate*** final results and time Time:
