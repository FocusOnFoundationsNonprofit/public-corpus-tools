...
'''
cd /Users/randytrue/Documents/Code/corpus-tools/web/aws_chalice/send-email
chalice deploy
'''

# API ENDPOINT: 
'''
  - LambdaARN: arn:aws:lambda:us-west-2:957789311461:function:send-email-dev
  - Rest API URL: https://lvyznjx395.execute-api.us-west-2.amazonaws.com/api/
'''

# TEST WITH CURL WITHOUT API KEY
# curl -X POST https://lvyznjx395.execute-api.us-west-2.amazonaws.com/api/send-email -H "Content-Type: application/json" -d '{"to_address": "randytrue@gmail.com", "email_subject": "CURL TEST of Lambda Function with SES Email", "from_address": "randy@floodlamp.bio", "email_body_plain": "Here is the plain text content of the email with headings, bold, italics, and a link.", "email_body_html": "<h1>Heading Level 1</h1><h2>Heading Level 2</h2><p>This is a <strong>bold</strong> text and this is an <em>italic</em> text.</p><p>Here is a link to <a href=\"https://example.com\">example.com</a>.</p>"}'

# TEST WITH CURL WITH API KEY
# curl -X POST https://lvyznjx395.execute-api.us-west-2.amazonaws.com/api/send-email -H "Content-Type: application/json" -H "x-api-key: efgh2..." -d '{"to_address": "randytrue@gmail.com", "email_subject": "CURL TEST of Lambda Function with SES Email", "from_address": "randy@floodlamp.bio", "email_body_plain": "Here is the plain text content of the email with headings, bold, italics, and a link.", "email_body_html": "<h1>Heading Level 1</h1><h2>Heading Level 2</h2><p>This is a <strong>bold</strong> text and this is an <em>italic</em> text.</p><p>Here is a link to <a href=\"https://example.com\">example.com</a>.</p>"}'

# TEST WITH CURL WITH JWT
# curl -X POST https://lvyznjx395.execute-api.us-west-2.amazonaws.com/api/send-email -H "Content-Type: application/json" -H "Authorization: Bearer eyJh..." -d '{"to_address": "randytrue@gmail.com", "email_subject": "CURL TEST of Lambda Function with SES Email", "from_address": "randy@floodlamp.bio", "email_body_plain": "Here is the plain text content of the email with headings, bold, italics, and a link.", "email_body_html": "<h1>Heading Level 1</h1><h2>Heading Level 2</h2><p>This is a <strong>bold</strong> text and this is an <em>italic</em> text.</p><p>Here is a link to <a href=\"https://example.com\">example.com</a>.</p>"}'
